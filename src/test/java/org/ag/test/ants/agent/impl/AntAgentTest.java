...
public class AntAgentTest {
    ...
    public void pheromoneSingleIncrementTest() {
        ...
        assertTrue(node.getCommunicationStimulus(ForageStimulusType.TYPE).getIntensity() == 0.1);

        node = (PheromoneNode) testAnt.getCurrentNode().getNeighbour(Direction.NORTH);
        assertTrue(node.getCommunicationStimulus(ForageStimulusType.TYPE).getIntensity() == 0);

        node = (PheromoneNode) testAnt.getCurrentNode().getNeighbour(Direction.NORTH_EAST);
        assertTrue(node.getCommunicationStimulus(ForageStimulusType.TYPE).getIntensity() == 0);

        node = (PheromoneNode) testAnt.getCurrentNode().getNeighbour(Direction.EAST);
        assertTrue(node.getCommunicationStimulus(ForageStimulusType.TYPE).getIntensity() == 0);

        node = (PheromoneNode) testAnt.getCurrentNode().getNeighbour(Direction.SOUTH_EAST);
        assertTrue(node.getCommunicationStimulus(ForageStimulusType.TYPE).getIntensity() == 0);

        node = (PheromoneNode) testAnt.getCurrentNode().getNeighbour(Direction.SOUTH);
        assertTrue(node.getCommunicationStimulus(ForageStimulusType.TYPE).getIntensity() == 0);

        node = (PheromoneNode) testAnt.getCurrentNode().getNeighbour(Direction.SOUTH_WEST);
        assertTrue(node.getCommunicationStimulus(ForageStimulusType.TYPE).getIntensity() == 0);

        node = (PheromoneNode) testAnt.getCurrentNode().getNeighbour(Direction.WEST);
        assertTrue(node.getCommunicationStimulus(ForageStimulusType.TYPE).getIntensity() == 0);

        node = (PheromoneNode) testAnt.getCurrentNode().getNeighbour(Direction.NORTH_WEST);
        assertTrue(node.getCommunicationStimulus(ForageStimulusType.TYPE).getIntensity() == 0);
    }
}
