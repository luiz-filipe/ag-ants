...
public class ForageTaskTest {
    private static final Logger logger = LoggerFactory.getLogger(ForageTaskTest.class);
    ...
    public void nodeSelectionTest() {
        ...
        // prepare the environment by adding the communication stimulus to the surrounding nodes.
        ...
        // Northwest is not necessary to update because will not contain communication stimulus. So let's put the agent
        // at the centre of the environment again.
        ant.moveToNeighbour(Direction.EAST);
        ...
        assertTrue((percentageN > (0.29 - allowedErrorMargin)) && (percentageN < (0.29 + allowedErrorMargin)));
        assertTrue((percentageNE > (0.21 - allowedErrorMargin)) && (percentageNE < (0.21 + allowedErrorMargin)));
        assertTrue((percentageE > (0.16 - allowedErrorMargin)) && (percentageE < (0.16 + allowedErrorMargin)));
        assertTrue((percentageSE > (0.12 - allowedErrorMargin)) && (percentageSE < (0.12 + allowedErrorMargin)));
        assertTrue((percentageS > (0.09 - allowedErrorMargin)) && (percentageS < (0.09 + allowedErrorMargin)));
        assertTrue((percentageSW > (0.06 - allowedErrorMargin)) && (percentageSW < (0.06 + allowedErrorMargin)));
        assertTrue((percentageW > (0.05 - allowedErrorMargin)) && (percentageW < (0.05 + allowedErrorMargin)));
        assertTrue((percentageNW > (0.03 - allowedErrorMargin)) && (percentageNW < (0.03 + allowedErrorMargin)));
