...
/**
 * This type represent ants from the worker cast in the colony. They are the main responsible for foraging. Ants from
 * this caste execute the following tasks:
 *
 * <ul>
 *     <li>ForageTask</li>
 *     <li>FindHomeNestTask</li>
 * </ul>
 *
...
public enum WorkerAntType implements AntType {
    ...
    private static final long millisecondsToWait = 5;
    ...
    public double getStimulusIncrement(String chemicalCommStimulusTypeName) {
        ...
        throw new RuntimeException( "WorkerType does not have an increment declared for '"
