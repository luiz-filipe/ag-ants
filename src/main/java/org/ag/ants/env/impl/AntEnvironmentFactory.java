...
public class AntEnvironmentFactory {
	 ...
	 * identifier following the pattern: "n+lineNumber,colunmNumber", e.g.
	 * "n3,2" corresponds to the node at the third line and second column.
	 * 
	 * @param nLines
	 ...
	 */
	public static PheromoneNode[][] createPheromoneNodeGrid(final int nLines,
			final int nColumns) {
