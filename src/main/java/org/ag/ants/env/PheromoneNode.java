...
/**
 * A specialisation of <em>BasicNode</em> used to create environments for ant simulations. Pheromone nodes have a list
 * of chemical stimulus that are present in the node.
 *
...
public class PheromoneNode extends BasicNode {
    /**
     * Constructs a pheromone node with an unique identifier.

     * @param id node's unique identififer.
     */
    ...
    /**
     * Tries to find the requested chemical communication stimulus in the list of communication stimulus. If one is
     * present, returns it, if none is found, a new chemical communication stimulus is created, put in the list and
     * returned.
     *
